  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary hover:bg-primary-600 text-white font-bold hover:bg-gray-900 hover:text-gray-50 focus:bg-primary focus:text-gray-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50 dark:hover:text-gray-900 dark:focus:bg-gray-50 dark:focus:text-gray-900",
        day_today: "bg-transparent border-2 border-secondary text-gray-900 dark:bg-gray-800 dark:text-gray-50",
        day_outside:
